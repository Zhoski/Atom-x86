...
# Double fault
gcc -m32 -march=i486 -ffreestanding -c src/kernel/services/panic/panic.c -w -o panic.o
...
qemu-system-i386 -cpu 486 -drive format=raw,file=atom.img -m 4M -icount shift=6,sleep=off -rtc clock=vm -no-reboot
