...
./utilities/afsm -c test25.img
./utilities/afsm -boot test25.img boot.bin
./utilities/afsm -push test25.img rootFS/stage2.bin
./utilities/afsm -push test25.img rootFS/kernel.bin
./utilities/afsm -push test25.img rootFS/shell.bin
./utilities/afsm -push test25.img rootFS/LICENSE.txt
./utilities/afsm -push test25.img rootFS/hello.bin
./utilities/afsm -push test25.img rootFS/init.bin
./utilities/afsm -push test25.img rootFS/init.cfg
./utilities/afsm -push test25.img rootFS/setup.bin
./utilities/afsm -push test25.img rootFS/notepad.bin

qemu-system-i386 -drive format=raw,file=test25.img -m 16M -icount shift=6,sleep=off -rtc clock=vm -no-reboot 
