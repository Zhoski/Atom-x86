...
./utilities/afsm -c test13.img
./utilities/afsm -boot test13.img boot.bin
./utilities/afsm -push test13.img rootFS/stage2.bin
./utilities/afsm -push test13.img rootFS/kernel.bin
./utilities/afsm -push test13.img rootFS/shell.bin
./utilities/afsm -push test13.img rootFS/LICENSE.txt
./utilities/afsm -push test13.img rootFS/hello.bin
./utilities/afsm -push test13.img rootFS/init.bin
./utilities/afsm -push test13.img rootFS/init.cfg
./utilities/afsm -push test13.img rootFS/setup.bin
./utilities/afsm -push test13.img rootFS/notepad.bin

qemu-system-i386 -drive format=raw,file=test13.img -m 16M -icount shift=6,sleep=off -rtc clock=vm -no-reboot 
