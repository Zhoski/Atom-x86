...
# Сервисы ядра
gcc -m32 -ffreestanding -c src/kernel/services/Memory/memory_managment.c -o memory_managment.o
...
ld -m elf_i386 -T linker.ld kernel.o vga.o keyboard.o idt.o pic.o isr33.o memory_managment.o -o kernel.elf
